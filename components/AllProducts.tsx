...
const AllProducts = () => {
    ...
    return (
        <div className='flex flex-row min-h-screen bg-orange-50 px-[15vw]'>
            {/* Categories Filter */}
            <aside className='hidden md:block w-56 px-4 py-10 bg-white rounded-2xl shadow-lg h-fit mt-16 ml-12'>
            ...
            {/* Main Content */}
            <div className='flex-1 px-0 md:px-0 py-12 md:py-16 mx-8'>
                ...
                <div className="flex flex-row gap-6 my-4 flex-wrap justify-center md:justify-start md:pl-4">
                    {paginatedProducts.map((product, idx) => (
                        <div key={product._id} className="w-72 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden group">
                            {/* Image Section */}
