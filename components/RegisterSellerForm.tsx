...
const RegisterSellerForm = () => {
    return (
        <div className='flex justify-center items-center min-h-screen gap-10'>
            {/* Contact Info Card */}
            <div className='bg-black bg-opacity-70 text-white p-10 rounded-lg w-[400px] max-w-md h-[400px] relative overflow-hidden flex-shrink-0'>
                <div className='gap-4'>
                    <h1 className='text-4xl font-bold mb-2'>Register your shop here</h1>
                    <p>Please fill in the details below to register your shop.</p>
                </div>
            ...
            {/* Contact Form Card */}
            <div className='flex flex-col items-center justify-center w-[620px] max-w-md'>
                <form className='p-10 rounded-lg w-full mt-0'>
                    ...
                    <button className='w-[200px] bg-black hover:bg-orange-600 text-white font-semibold py-2 px-4 rounded-lg transition' type='submit'>Register</button>
                </form>
            </div>
        </div>
    )
