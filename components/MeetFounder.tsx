...
const MeetFounder = () => {
  return (
    <div className={`flex flex-col md:flex-row items-center justify-between ${CONTAINER_PADDING} gap-8`}>
        <AnimatedSection direction="left" className='flex flex-col items-start w-full md:w-1/2 gap-4'>
        ...
        <AnimatedSection direction="right" delay={0.2} className='w-full md:w-1/2 flex justify-end mt-8 md:mt-0'>
