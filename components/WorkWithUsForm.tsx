...
const WorkWithUsForm = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-center items-center min-h-screen gap-6 md:gap-10 px-4 sm:px-8">
      {/* Contact Info Card */}
      <div className='bg-black bg-opacity-70 text-white p-10 rounded-lg w-full md:w-[600px] max-w-md h-[400px] relative overflow-hidden flex-shrink-0'>
        <div className='gap-4'>
          <h1 className='text-3xl sm:text-4xl font-bold mb-2'>Work with us!</h1>
          <p className='text-sm sm:text-base'>Join our team and help us create amazing products!</p>
        </div>
      ...
      <div className='flex flex-col items-center justify-center w-full md:w-[420px] max-w-md'>
        <form className='p-6 sm:p-10 rounded-lg w-full mt-0' onSubmit={handleSubmit} encType="multipart/form-data">
          <div className='mb-4'>
